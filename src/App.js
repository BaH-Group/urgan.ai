...
export default function App() {
  ...
  return (
    <div className="h-screen bg-slate-100 p-2 md:p-6 lg:p-8 font-sans flex flex-col items-center text-slate-900 overflow-hidden">
      <div className="w-full max-w-5xl flex justify-between items-center bg-white p-3 md:p-5 rounded-3xl shadow-sm mb-4 border border-slate-200 shrink-0">
        <div className="text-sky-600 font-bold text-base md:text-xl">
          Round {puzzleNumber} / {totalRounds}
        </div>
        <div className="text-amber-500 font-black text-xl md:text-3xl">
          Score: {score}
        </div>
      </div>

      <div className="w-full max-w-5xl mb-6 shrink-0 px-2">
        <div className="flex justify-between text-[10px] md:text-sm font-bold text-slate-500 mb-2">
          <span>Time Remaining</span>
          <span className={timeLeft <= 5 ? "text-rose-500 animate-pulse font-black text-base" : "text-base text-slate-700"}>{timeLeft}s</span>
        </div>
        <div className="w-full bg-slate-200 rounded-full h-2 md:h-4 overflow-hidden shadow-inner">
          <div 
      ...
      <div className="w-full max-w-5xl flex-1 flex flex-col items-center justify-center overflow-y-auto min-h-0 pb-6 custom-scrollbar px-2">
        <TopicGameComponent 
